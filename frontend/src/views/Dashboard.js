...
function Dashboard() {
  ...
  const AUTH_URL = `https://www.fitbit.com/oauth2/authorize?response_type=token&client_id=${CLIENT_ID}&redirect_uri=${encodeURIComponent(
    REDIRECT_URI
  ...
  const calorieProgressPercentage = Math.min(
    (caloriesBurned / CALORIE_GOAL) * 100,
    100
  ); // Limit to 100%
  ...
  const calorieStroke =
    (calorieProgressPercentage / 100) * calorieCircleCircumference; // Filled stroke length for calories
  ...
  const handleFileUpload = (event) => {
    ...
    axios
      .post("http://127.0.0.1:5002/upload", data, {})
      .then(function (response) {
        ...
        today = dd + "/" + mm + "/" + yyyy;
        console.log(state);
        state.patient.methods
          .saveFile(file.name, response.data["Hash"], today)
                ...
                <Table>
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>Eat 5 servings of vegetables</td>
                      <td className="td-actions text-right">
                        <OverlayTrigger
                          overlay={
                    ...
                    <tr>
                      ...
                      <td>Unfollow unhealthy habits</td>
                      <td className="td-actions text-right">
                        <OverlayTrigger
                          overlay={
              ...
              {fitbitData ? (
                <div className="d-flex justify-content-center align-items-center">
                  ...
                  <div className="d-flex justify-content-center align-items-center flex-column">
                    ...
                    <p className="mt-3">
                      Goal: <strong>{STEP_GOAL} steps</strong>
                    </p>
                  </div>
                </div>
              ) : error ? (
                <div>
                  ...
                  <Button variant="danger" onClick={handleFitbitLogin}>
                    Retry
                  </Button>
                </div>
              ) : (
